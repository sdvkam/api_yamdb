## Сервис для обсуждения произведений искуства: Книги, Фильмы, Музыка
...
### 2. Досутпные URL адреса
- http://127.0.0.1:8000/redoc/ - описание API, которое было реализовано в проекте
- http://127.0.0.1:8000/admin/ - админ-панель Django
- http://127.0.0.1:8000/api/v1/ - доступ к API
